  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f7f8fc", fontFamily: SF_PRO }}>
      ...
      <div style={{ padding: "20px" }}>
        ...
        <Card>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 0 }}>
            {/* F3: emoji abre bottom sheet con sugerencias */}
            <button
        ...
        <Card style={{ border: catError && selectedCategories.length === 0 ? "2px solid #ff6b6b" : "none" }}>
          ...
          {/* F6: botón + Nueva igual a SettingsScreen */}
      ...
      {showEmojiSheet && (
        ...
        >
          <div
            style={{ background: "#fff", borderRadius: "24px 24px 0 0", width: "100%", padding: "24px 20px calc(40px + env(safe-area-inset-bottom))", fontFamily: SF_PRO }}
            onClick={e => e.stopPropagation()}
            onTouchMove={e => e.stopPropagation()}
          >
            <div style={{ width: 36, height: 4, background: "#e8e8e8", borderRadius: 2, margin: "0 auto 20px" }} />
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
              {EMOJI_OPTIONS.map(e => (
                <button key={e} onClick={() => { setSelectedEmoji(e); setShowEmojiSheet(false); }}
      ...
      {showNewCatModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 200, display: "flex", alignItems: "flex-end" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", width: "100%", padding: "24px 20px 44px", fontFamily: SF_PRO }}>
            <div style={{ width: 36, height: 4, background: "#e8e8e8", borderRadius: 2, margin: "0 auto 20px" }} />
            ...
            <button onClick={() => { addCustomCat(); setShowNewCatModal(false); }} disabled={!newCatLabel.trim()}
            ...
            <button onClick={() => { setShowNewCatModal(false); setNewCatLabel(""); }}
