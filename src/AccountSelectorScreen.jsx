...
export default function AccountSelectorScreen({ user, accounts, onSelect, onCreated }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, background: colors.bg, fontFamily: SF, overflowY:"auto", paddingBottom: "env(safe-area-inset-bottom)", paddingTop: "env(safe-area-inset-top)", paddingLeft:"env(safe-area-inset-left)", paddingRight:"env(safe-area-inset-right)", boxSizing: "border-box" }}>
