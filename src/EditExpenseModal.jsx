        ...
        {isDesktop ? (
          <div style={{ padding: 28, position: 'relative', fontFamily: FONT }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: colors.text, fontFamily: FONT }}>Editar Gasto</h2>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              ...
              <button type="button" onClick={handleSave} disabled={!isSaveable} style={{ flex: 2, padding: '14px 0', borderRadius: 12, border: 'none', background: isSaveable ? '#4F7FFA' : '#aaa', color: '#fff', fontSize: 15, fontWeight: 600, cursor: isSaveable ? 'pointer' : 'default', fontFamily: FONT }}>
